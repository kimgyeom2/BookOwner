...
import com.gy25m.bookowner.adapters.NewAdapter
import com.gy25m.bookowner.databinding.FragmentBestBinding
import com.gy25m.bookowner.databinding.FragmentNewBinding
...
class NewFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        retrofitApiservice.booklist("ItemNewSpecial","ttbrlarua72021535002").enqueue(object : Callback<AladinBookList>{
            override fun onResponse(
                call: Call<AladinBookList>,
                response: Response<AladinBookList>
            ) {
                val ala=response.body()
                binding.recyclerNew.adapter=BestAdapter(activity as MainActivity,ala!!.item)
            }
