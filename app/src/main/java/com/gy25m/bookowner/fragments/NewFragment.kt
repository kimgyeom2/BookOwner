...
class NewFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val call: Call<AladinBookList> = retrofitService.booklist("ItemNewSpecial","ttbrlarua72021535002")
        ...
        call.enqueue(object : Callback<AladinBookList> {
            override fun onResponse(
                ...
                binding.recyclerNew.adapter= NewAdapter(activity as MainActivity,ala!!.item)
            }
